...
В папке `screenshots/` приведены примеры результатов работы аналитических витрин.
Скриншоты показывают вывод SQL-запросов из PostgreSQL после выполнения всех DAG в Airflow.

* `mart_user_activity` — агрегированная статистика пользовательских сессий.
* `mart_support_stats` — статистика обращений в поддержку по типам проблем и статусам.
